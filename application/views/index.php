	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?=base_url()?>index.php" class="active"><i class="lnr lnr-home"></i> <span>Home</span></a></li>
						<li><a href="<?=base_url()?>index.php/user/profil" class=""><i class="lnr lnr-code"></i> <span>Profil</span></a></li>
						</li>
					</ul>
				</nav>
			</div>
